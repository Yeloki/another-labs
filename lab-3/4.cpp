...
double firstDerivativeCentered(const vector<double> &x, const vector<double> &y,
                               double x_star, double h) {
  int n = x.size();
  for (int i = 0; i < n; ++i) {
    if (x[i] == x_star) {
...
double secondDerivativeCentered(const vector<double> &x,
                                const vector<double> &y, double x_star,
                                double h) {
  int n = x.size();
  for (int i = 0; i < n; ++i) {
    if (x[i] == x_star) {
...
double firstDerivativeForward(const vector<double> &x, const vector<double> &y,
                              double x_star, double h) {
  int n = x.size();
  for (int i = 0; i < n - 1; ++i) {
    if (x[i] == x_star && i + 1 < n) {
...
double secondDerivativeForward(const vector<double> &x, const vector<double> &y,
                               double x_star, double h) {
  int n = x.size();
  for (int i = 0; i < n - 2; ++i) {
    if (x[i] == x_star && i + 2 < n) {
...
double firstDerivativeBackward(const vector<double> &x, const vector<double> &y,
                               double x_star, double h) {
  int n = x.size();
  for (int i = 1; i < n; ++i) {
    if (x[i] == x_star) {
...
double secondDerivativeBackward(const vector<double> &x,
                                const vector<double> &y, double x_star,
                                double h) {
  int n = x.size();
  for (int i = 2; i < n; ++i) {
...
int main() {
  ...
  cout << "Первая производная: " << fixed << setprecision(6)
       << first_derivative_centered << endl;
  cout << "Вторая производная: " << fixed << setprecision(6)
       << second_derivative_centered << endl;

  cout << "\nНаправленные вправо разности:" << endl;
  cout << "Первая производная: " << fixed << setprecision(6)
       << first_derivative_forward << endl;
  cout << "Вторая производная: " << fixed << setprecision(6)
       << second_derivative_forward << endl;

  cout << "\nНаправленные влево разности:" << endl;
  cout << "Первая производная: " << fixed << setprecision(6)
       << first_derivative_backward << endl;
  cout << "Вторая производная: " << fixed << setprecision(6)
       << second_derivative_backward << endl;
