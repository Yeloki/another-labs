...
double objectiveFunction(double x) { return 1.0 / tan(x) + x; }
...
double newtonInterpolation(const vector<double> &x, const vector<double> &y,
                           double x_star) {
  int n = x.size();
...
int main() {
  ...
  cout << "Интерполяция многочленом Лагранжа (a): " << fixed << setprecision(6)
       << lagrange_result_a << endl;
  cout << "Интерполяция многочленом Лагранжа (б): " << fixed << setprecision(6)
       << lagrange_result_b << endl;
  ...
  cout << "Интерполяция многочленом Ньютона (a): " << fixed << setprecision(6)
       << newton_result_a << endl;
  cout << "Интерполяция многочленом Ньютона (б): " << fixed << setprecision(6)
       << newton_result_b << endl;

  // Точное значение функции в точке x_star
  double exact_value = objectiveFunction(x_star);
  cout << "Точное значение функции: " << fixed << setprecision(6) << exact_value
       << endl;
  ...
  cout << "Погрешность интерполяции Лагранжа (a): " << fixed << setprecision(6)
       << lagrange_error_a << endl;
  cout << "Погрешность интерполяции Лагранжа (б): " << fixed << setprecision(6)
       << lagrange_error_b << endl;
  cout << "Погрешность интерполяции Ньютона (a): " << fixed << setprecision(6)
       << newton_error_a << endl;
  cout << "Погрешность интерполяции Ньютона (б): " << fixed << setprecision(6)
       << newton_error_b << endl;
