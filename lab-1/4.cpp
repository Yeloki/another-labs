...
void jacobiMethod(vector<vector<double>>& A, vector<vector<double>>& eigenvectors, double tol, int& iterations) {
    int n = A.size();
    ...
    do {
        ...
        A[p][p] = cos_theta * cos_theta * a_pp - 2.0 * cos_theta * sin_theta * a_pq + sin_theta * sin_theta * a_qq;
        A[q][q] = sin_theta * sin_theta * a_pp + 2.0 * cos_theta * sin_theta * a_pq + cos_theta * cos_theta * a_qq;
        A[p][q] = 0.0;
        A[q][p] = 0.0;
